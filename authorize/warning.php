    ...
    <div class="col-md-12 mb-3">
            <div class="card bg-custom text-white">
              <div class="card-header">
                <span><i class="bi bi-exclamation-triangle me-2"></i></span> Warning List
              </div>
              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-success me-md-2" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><span><i class="bi bi-plus-circle me-2"></i></span>Add Warning</button>
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog text-dark">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add Warning</h5>
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="user" style="background: #212529;color: white;">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: <?=$row['color']?>;color: black;">
                                <td scope="row"><center><?=$row['sign_level']?></center></td>
                                <td><?=$row['surge_name']?></td>
                                <td><?=$row['info']?></td>
                                <td><?=$row['meter']?> Meter</td>
                                <td>
                                    <center>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic mixed styles example">
                                            <form action="function_warning.php" method="post" id="deletefr">
                                            </form>
                                            <button type="submit" name="delete" form="deletefr" value="<?=$row['warning_id']?>" class="btn btn-danger">Delete</button>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit-modal" data-id="<?=$row['warning_id']?>" id="getUser">Edit</button>
                                        </div>
                                    </center>
                                </td>
                            </tr>
                    ...
                    <div class="modal fade" id="edit-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-dialog text-dark">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="edit-modal">Edit Warning</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div id="content">
